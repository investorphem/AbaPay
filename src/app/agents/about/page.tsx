...
import { ArrowLeft, Fingerprint, Building2, Rocket, Workflow, ExternalLink, CheckCircle2, Compass } from "lucide-react";
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60">
              ...
              <tr>
                ...
                <td className="py-2.5 pr-4"><a href="https://github.com/punkpeye/awesome-mcp-servers#-finance--fintech" target="_blank" rel="noopener noreferrer" className="text-emerald-600 dark:text-emerald-400 hover:underline">Finance &amp; Fintech</a></td>
                <td className="py-2.5 text-slate-400 dark:text-slate-500">Merged</td>
              </tr>
              <tr>
      ...
      <section className="bg-white dark:bg-[#111114] border border-slate-100 dark:border-slate-800/60 rounded-[2rem] p-6 sm:p-8">
        <div className="grid sm:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
              Listed on the official MCP Registry, on-chain via ERC-8004, approved on <a href="https://glama.ai/mcp/servers/investorphem/AbaPay" target="_blank" rel="noopener noreferrer" className="underline hover:text-emerald-500">Glama&apos;s server directory</a> and its <a href="https://glama.ai/mcp/connectors" target="_blank" rel="noopener noreferrer" className="underline hover:text-emerald-500">connector directory</a>, live on <a href="https://mcpplaygroundonline.com/mcp-servers/investorphem-abapay" target="_blank" rel="noopener noreferrer" className="underline hover:text-emerald-500">MCP Playground&apos;s server registry</a>, and merged into <a href="https://github.com/punkpeye/awesome-mcp-servers#-finance--fintech" target="_blank" rel="noopener noreferrer" className="underline hover:text-emerald-500">awesome-mcp-servers</a> (95k+ stars). Full list: <a href="#discovery" className="underline hover:text-emerald-500">above</a>.
            </p>
          </div>
        </div>
      </section>
