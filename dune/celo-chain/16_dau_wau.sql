-- AbaPay on Celo — DAU / WAU / MAU
-- Reads the root query's materialized view; never touches celo.logs. See 00_events.sql.
--
-- Because this dashboard is Celo-scoped at the source, a wallet that pays on Base
-- does NOT inflate these counts — which is exactly why the Celo numbers are worth
