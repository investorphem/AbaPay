...
export default function Home() {
  ...
  const processBlockchainPayment = async () => {
    ...
    try {
      ...
      if (isMainnet) {
        if (selectedToken.symbol === "USD₮") feeAdapter = "0x48065fbbe25f71c9282ddf5e1cd6d6a887483d5e"; 
        else if (selectedToken.symbol === "USDC") feeAdapter = "0xcebA9300f2b948710d2653dD7B07f33A8B32118C"; 
        else if (selectedToken.symbol === "cUSD") feeAdapter = "0x765DE816845861e75A25fCA122bb6898B8B1282a";
      } else {
        if (selectedToken.symbol === "USDC") feeAdapter = "0x01C5C0122039549AD1493B8220cABEdD739BC44E"; 
      }
