...
export const metadata: Metadata = {
  ...
  description: "AbaPay's Agent Card and JSON-RPC endpoint for peer agents — discovery, skills, and how the linked-wallet PIN works, entirely by API.",
};
  ...
  return (
    <>
      ...
      <section className="bg-white dark:bg-[#111114] border border-slate-100 dark:border-slate-800/60 rounded-[2rem] p-6 sm:p-8 mb-6">
        <h2 className="font-black text-slate-900 dark:text-white mb-3">Skills (10)</h2>
