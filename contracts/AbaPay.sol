...
contract AbaPa
    // The "Boss" variable - This will permanently record your adin wallet address
    address public owner;
    // SECURITY: A whitelist of approved tokens
    mapping(address => bool) public isSupportedToken;

    // The blockchain receipt generators
    event PaymentReceived(address indexed user, address indexed token, string serviceType, string accountumber, uint256 amo
